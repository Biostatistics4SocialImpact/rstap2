...
// test_grads_glmer
Rcpp::List test_grads_glmer(Eigen::VectorXd& y, Eigen::MatrixXd& Z, Eigen::MatrixXd& W, Eigen::VectorXd& true_b_int, Eigen::VectorXd& true_b_slope, Eigen::VectorXd& beta_bar, Eigen::VectorXd& beta, Eigen::ArrayXXd& distances, Eigen::ArrayXXi& u_crs, Eigen::MatrixXd& subj_array, Eigen::MatrixXd& subj_n, Eigen::VectorXd& par_grid, Eigen::ArrayXi& stap_par_code, const int seed);
RcppExport SEXP _rstap2_test_grads_glmer(SEXP ySEXP, SEXP ZSEXP, SEXP WSEXP, SEXP true_b_intSEXP, SEXP true_b_slopeSEXP, SEXP beta_barSEXP, SEXP betaSEXP, SEXP distancesSEXP, SEXP u_crsSEXP, SEXP subj_arraySEXP, SEXP subj_nSEXP, SEXP par_gridSEXP, SEXP stap_par_codeSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< Eigen::ArrayXi& >::type stap_par_code(stap_par_codeSEXP);
    Rcpp::traits::input_parameter< const int >::type seed(seedSEXP);
    rcpp_result_gen = Rcpp::wrap(test_grads_glmer(y, Z, W, true_b_int, true_b_slope, beta_bar, beta, distances, u_crs, subj_array, subj_n, par_grid, stap_par_code, seed));
    return rcpp_result_gen;
END_RCPP
}
